      ...
      e: for (var K = 0, q = C.length, pr = q >>> 1; K < pr; ) {
        ...
        if (0 > l(Vl, R))
          Ct < q && 0 > l(hr, Vl)
            ? ((C[K] = hr), (C[Ct] = R), (K = Ct))
            : ((C[K] = Vl), (C[xt] = R), (K = xt));
        else if (Ct < q && 0 > l(hr, R)) (C[K] = hr), (C[Ct] = R), (K = Ct);
        else break e;
      }
    }
    return T;
...
function qf(e, t, n, r, l, o, i, u, s) {
  (Fn = !1), (Yr = null), Gf.apply(Zf, arguments);
}
function bf(e, t, n, r, l, o, i, u, s) {
  if ((qf.apply(this, arguments), Fn)) {
    if (Fn) {
      var a = Yr;
      (Fn = !1), (Yr = null);
...
var va = Se.unstable_scheduleCallback,
  ...
  td = Se.unstable_shouldYield,
  nd = Se.unstable_requestPaint,
  J = Se.unstable_now,
  rd = Se.unstable_getCurrentPriorityLevel,
...
var je = Math.clz32 ? Math.clz32 : sd,
  id = Math.log,
  ud = Math.LN2;
function sd(e) {
...
var hn = {
  ...
  El = V({}, sr, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== xn &&
            (xn && e.type === "mousemove"
              ? ((Gl = e.screenX - xn.screenX), (Zl = e.screenY - xn.screenY))
              : (Zl = Gl = 0),
            (xn = e)),
          Gl);
    },
  ...
  Du = ke(El),
  gd = V({}, El, { dataTransfer: 0 }),
  wd = ke(gd),
  Sd = V({}, sr, { relatedTarget: 0 }),
  ql = ke(Sd),
...
var Od = V({}, sr, {
  ...
  Dd = ke(Fd),
  jd = V({}, hn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ad = ke(jd),
  Md = V({}, El, {
    deltaX: function (e) {
...
var Bd = Ze && "TextEvent" in window && !Dn,
  Ra = Ze && (!Ai || (Dn && 8 < Dn && 11 >= Dn)),
...
function Hd(e, t) {
  if (Ht)
    return e === "compositionend" || (!Ai && Oa(e, t))
      ? ((e = Ta()), (jr = Fi = st = null), (Ht = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
var qd = Ze && "documentMode" in document && 11 >= document.documentMode,
  Vt = null,
  $o = null,
  An = null,
  Ho = !1;
...
var Ln =
  ...
  tp = new Set("cancel close invalid load scroll toggle".split(" ").concat(Ln));
function Ku(e, t, n) {
...
var Ko = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  op =
    typeof queueMicrotask == "function"
      ...
      : typeof Yu < "u"
      ? function (e) {
          return Yu.resolve(null).then(e).catch(ip);
        }
      : Ko;
function ip(e) {
  setTimeout(function () {
...
function bo(e, t, n, r) {
  var l = e.stateNode;
  (l.props = n), (l.state = e.memoizedState), (l.refs = qa), Qi(e);
  var o = t.contextType;
  typeof o == "object" && o !== null
    ? (l.context = Te(o))
...
function ec(e) {
  ...
  function y(f, c, d, S) {
    ...
    if (P === d.length) return n(f, N), B && _t(f, P), x;
    if (N === null) {
      for (; P < d.length; P++)
        (N = h(f, d[P], S)),
          N !== null &&
  ...
  function g(f, c, d, S) {
    ...
    for (
      var _ = (x = null), N = c, P = (c = 0), Q = null, L = d.next();
      N !== null && !L.done;
      P++, L = d.next()
    ) {
      N.index > P ? ((Q = N), (N = null)) : (Q = N.sibling);
    ...
    if (L.done) return n(f, N), B && _t(f, P), x;
    if (N === null) {
...
function vc(e, t, n) {
  return Dt & 21
    ? (Me(n, t) || ((n = Sa()), (H.lanes |= n), (jt |= n), (e.baseState = !0)),
      t)
...
function hp(e, t, n) {
  ...
  if (wc(e)) Sc(t, l);
    ...
    (n = Ga(e, t, l, r)),
      n !== null && ((l = ae()), Ae(n, e, r, l), Ec(n, t, r));
  }
}
function wc(e) {
  var t = e.alternate;
...
var dl = {
  ...
  vp = {
    ...
    useDeferredValue: function (e) {
      var t = Re();
      return Y === null ? (t.memoizedState = e) : vc(t, Y.memoizedState, e);
    },
    useTransition: function () {
      var e = fo(nr)[0],
        t = Re().memoizedState;
...
function ni(e, t, n, r, l, o) {
  Nc(e, t);
  var i = (t.flags & 128) !== 0;
  if (!r && !i) return l && qu(t, n, !1), et(e, t, o);
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || $.current & 1 ? G === 0 && (G = 3) : iu())),
          t.updateQueue !== null && (t.flags |= 4),
          oe(t),
          null);
    case 4:
      return (
        an(), oi(e, t), e === null && Gn(t.stateNode.containerInfo), oe(t), null
      );
    case 10:
...
function Fc(e) {
  ...
  t !== null && ((e.alternate = null), Fc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Be], delete t[qn], delete t[Jo], delete t[up], delete t[sp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ae(e, t, n, r) {
  if (50 < Bn) throw ((Bn = 0), (fi = null), Error(E(185)));
  ur(e, n, r),
    (!(j & 2) || e !== ee) &&
      (e === ee && (!(j & 2) && (Rl |= n), G === 4 && ut(e, ne)),
      ye(e, r),
      n === 1 && j === 0 && !(t.mode & 1) && ((fn = J() + 500), _l && kt()));
}
function ye(e, t) {
...
function Ic(e, t) {
  if ((($r = -1), (Hr = 0), j & 6)) throw Error(E(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = yl(e, r);
    ...
    j |= 2;
    var o = Bc();
    (ee !== e || ne !== t) && ((Qe = null), (fn = J() + 500), Ot(e, t));
    do
      try {
        Op();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = lr), Ot(e, 0), ut(e, r), ye(e, J()), n);
    if (t === 6) ut(e, r);
    else {
      if (
...
function ks(e) {
  ...
  if (n === 1) throw ((n = lr), Ot(e, 0), ut(e, t), ye(e, J()), n);
...
function lu(e, t) {
  ...
  try {
    ...
    (j = n), j === 0 && ((fn = J() + 500), _l && kt());
  }
}
function At(e) {
  at !== null && at.tag === 0 && !(j & 6) && rn();
  var t = j;
  j |= 1;
  var n = Ne.transition,
    r = A;
  try {
    ...
    (A = r), (Ne.transition = n), (j = t), !(j & 6) && kt();
  }
}
function ou() {
  (ve = Zt.current), U(Zt);
...
function Ot(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), lp(n)), X !== null))
...
function yl(e, t) {
  ...
  while (1);
  if ((Hi(), (j = n), (pl.current = r), X !== null)) throw Error(E(261));
...
function Nt(e, t, n) {
  var r = A,
    l = Ne.transition;
  try {
    (Ne.transition = null), (A = 1), Lp(e, t, n, r);
  } finally {
    (Ne.transition = l), (A = r);
  }
  return null;
  ...
  if (at !== null) {
    ...
    try {
      if (((Ne.transition = null), (A = 16 > e ? 16 : e), at === null))
        ...
        if (((e = at), (at = null), (ml = 0), j & 6)) throw Error(E(331));
        var l = j;
        ...
        if (
          ((j = l), kt(), He && typeof He.onPostCommitFiberRoot == "function")
        )
          try {
...
function zp(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    ee === e &&
      (ne & n) === n &&
      (G === 4 || (G === 3 && (ne & 130023424) === ne && 500 > J() - ru)
        ? Ot(e, 0)
        : (nu |= n)),
    ye(e, t);
}
...
Wc = function (e, t, n) {
  ...
  else (pe = !1), B && t.flags & 1048576 && Ja(t, il, t.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Oi(t, n | 1), ye(t, J()), !(j & 6) && ((fn = J() + 500), kt()));
      }
      break;
    case 13:
      At(function () {
...
fa = lu;
da = At;
var $p = { usingClientEntryPoint: !1, Events: [ar, Qt, Cl, aa, ca, lu] },
  Nn = {
...
const Eh = (e) => {
  ...
  kh = We("AsyncFunction"),
  xh = (e) => e && (Ml(e) || Pe(e)) && Pe(e.then) && Pe(e.catch),
  v = {
    isArray: yn,
    isArrayBuffer: Zc,
    isBuffer: Qp,
    ...
    return (
      ...
      s
        ...
        : ((!l[i] || !v.isObject(l[i])) && (l[i] = []),
          t(n, r, l[i], o) && v.isArray(l[i]) && (l[i] = Ah(l[i])),
          !u)
    );
  }
...
function pf(e, t) {
  return e && !Jh(t) ? Xh(e, t) : t;
}
const Yh = $e.isStandardBrowserEnv
  ? (function () {
...
const qh = typeof XMLHttpRequest < "u",
  bh =
    qh &&
    function (e) {
...
Z.mergeConfig = dn;
Z.AxiosHeaders = Ge;
Z.formToJSON = (e) => ff(v.isHTMLForm(e) ? new FormData(e) : e);
Z.HttpStatusCode = om;
Z.default = Z;
const im = Z;
function um({ product: e }) {
  return F.jsx("div", {
    children: F.jsxs("div", {
      className:
        ...
        F.jsxs("a", {
          ...
          children: [
            ...
            F.jsxs("span", {
              ...
              children: [e.discountPercentage, " %OFF"],
            }),
          ],
        }),
        F.jsxs("div", {
          ...
          children: [
              ...
              children: [
                ...
                F.jsxs("div", {
                  ...
                  children: [
                    ...
                    F.jsx("span", {
                      className:
                        "mr-2 ml-3 rounded bg-yellow-200 px-2.5 py-0.5 text-xs font-semibold",
                      children: e.rating,
                    }),
                  ],
                }),
            ...
            F.jsxs("a", {
              href: "#",
              className:
                "flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300",
              children: [
                F.jsx("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
...
function sm() {
  ...
  return (
    $n.useEffect(() => {
      im({ method: "GET", url: "http://localhost:8080/products" })
        .then((n) => {
          const r = n.data;
          t(r), console.log(r);
        })
    ...
    F.jsxs("div", {
      children: [
        F.jsx("h1", { children: "Product List" }),
        F.jsx("div", {
          className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3",
          children: e.map((n) => F.jsx(um, { product: n }, n.id)),
        }),
      ],
    })
  );
...
Eo.createRoot(document.getElementById("root")).render(
  F.jsx(Ff.StrictMode, { children: F.jsx(sm, {}) })
);
